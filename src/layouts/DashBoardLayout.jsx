  ...
  <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-5 border border-white/10">
    ...
    <div className="flex items-center gap-4">
      <div className="relative">
        ...
        <span className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-slate-900"></span>
      </div>
      ...
      >
        ...
        <aside
          className={`absolute left-0 top-0 h-full w-72 bg-gradient-to-b from-cyan-900 via-blue-900 to-sky-800 transform transition-transform duration-300 ${
        ...
        >
          ...
          <div className="p-4">
            <button
              onClick={handleLogout}
              className="w-full py-3 rounded-xl bg-red-500/20 text-white"
            >
              Logout
            </button>
          </div>
