...
>
  ...
  <span className="absolute -inset-2 rounded-full bg-green-400/20 blur-xl animate-pulse" />
      ...
      <AnimatePresence>
        {show && (
          ...
          >
            ...
            {/* blue glow aura */}
            <span className="absolute inset-0 rounded-full bg-blue-400/30 blur-2xl animate-pulse" />
          </motion.button>
        )}
      </AnimatePresence>
